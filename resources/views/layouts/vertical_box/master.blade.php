...
<html lang="en" dir="ltr">
   <head>
      ...
      @include('layouts.vertical_box.css')
      @yield('style')
   </head>
   <body class="light-only" main-theme-layout="box-layout">
      ...
      <div class="page-wrapper horizontal-wrapper" id="pageWrapper">
         <!-- Page Header Start-->
         @include('layouts.vertical_box.header')
         <!-- Page Header Ends -->
         <!-- Page Body Start-->
         <div class="page-body-wrapper horizontal-menu">
            <nav-menus></nav-menus>
            @include('layouts.vertical_box.sidebar')
            <!-- Page Sidebar Ends-->
            <div class="page-body">
            ...
            <!-- footer start-->
            @include('layouts.vertical_box.footer')
         </div>
      </div>
      @include('layouts.vertical_box.script')
   </body>
</html>