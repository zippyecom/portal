...
<html lang="en">
   <head>
      ...
      <link rel="icon" href="{{asset('assets/images/zippy/icon-1-01.jpg')}}" type="image/x-icon">
      <link rel="shortcut icon" href="{{asset('assets/images/zippy/icon-1-01.jpg')}}" type="image/x-icon">
