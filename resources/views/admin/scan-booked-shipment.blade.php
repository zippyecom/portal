...
@section('title', 'Shipment Arrived')
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="">
        ...
        {{-- <div class="card-body">
          <form action="{{route('barcode-search')}}" method="get" id="barcode-form" class="scan-box"> --}}
          ...
          <div class="card" id="card-ship">
            <div class="card-body">
              ...
              if(shipment.status == "Booked" || shipment.status == "Pickup"){
                ...
                $(wrapper).append(`@hasrole('admin')
                <a class="btn btn-success btn-block mt-3 btnAction" href="/shipment-tracking/`+shipment['id']+`">In-Transit</a>@endhasrole
                `);
              }
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <form class="theme-form" method="POST" action="{{route('shipment-comments')}}" id="my_form">
