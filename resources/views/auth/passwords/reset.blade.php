        ...
        <form class="login100-form validate-form" method="POST" action="{{ route('password.update') }}">
          ...
          <div class="row w-100" style="margin: 0 !important">
            <div class="col-12 input-wrap">
              <input id="email" class="input100 form-control @error('email') is-invalid @enderror" type="email" name="email" placeholder="Email" value="{{ $email ?? old('email') }}" required autocomplete="email">
          ...
          <div class="row w-100" style="margin: 0 !important">
            <div class="col-12 input-wrap">
              <input id="password" class="input100 form-control @error('password') is-invalid @enderror" type="password" name="password" placeholder="Password" required autocomplete="new-password" autofocus>
          ...
          <div class="row w-100" style="margin: 0 !important">
            <div class="col-12 input-wrap">
              <input id="password-confirm" class="input100 form-control @error('email') is-invalid @enderror" type="password" name="password_confirmation" placeholder="Confirm Password" required autocomplete="new-password" autofocus>
            </div>
          </div>
