...
<html lang="en" dir="rtl">
   <head>
      ...
      @include('layouts.vertical_rtl.css')
      @yield('style')
   </head>
   <body class="light-only" main-theme-layout="rtl">
      ...
      <div class="page-wrapper horizontal-wrapper" id="pageWrapper">
         <!-- Page Header Start-->
         @include('layouts.vertical_rtl.header')
         <!-- Page Header Ends -->
         <!-- Page Body Start-->
         <div class="page-body-wrapper horizontal-menu">
            <nav-menus></nav-menus>
            @include('layouts.vertical_rtl.sidebar')
            <!-- Page Sidebar Ends-->
            <div class="page-body">
            ...
            <!-- footer start-->
            @include('layouts.vertical_rtl.footer')
         </div>
      </div>
      @include('layouts.vertical_rtl.script')
   </body>
</html>