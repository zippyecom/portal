...
<link rel="icon" href="/storage/logos/<?php echo e($settings->icon); ?>" type="image/x-icon">
<link rel="shortcut icon"  href="/storage/logos/<?php echo e($settings->icon); ?>" type="image/x-icon">
  ...
  <tr>
    <td>
      <table class="tab" cellpadding="0" cellspacing="0" style="font-size:10px;font-family:arial;">
        <tr>
        <td rowspan="3" class="tdl" width="100">&nbsp;<img src="<?php echo e(asset('assets/images/zippy/logo.svg')); ?>" height=33 width=90><br><span style="font-size:10px; ">&nbsp;&nbsp;A ZIPPY (Pvt) Ltd<?php echo e($shipment->consignment_no); ?></span>
          </td>
          <td rowspan="3" colspan="2" valign="bottom" width="85" class="tdl" align="center"><div id="barcodec" style="font-weight: 100;">
            <?php echo DNS1D::getBarcodeHTML($shipment->consignment_no, 'C39E', 1,33,'black', true);; ?></div><span style="font-size:9px;">Accounts Copy</span></td>
          <td class="tdl" rowspan="3" colspan="4"><span style="font-weight: bold; font-size: 14px;"><?php echo e($shipment->user->company->company_name); ?></span> <br><?php echo e($shipment->user->company->address); ?><br><?php echo e($shipment->user->company->phone); ?><br><?php echo e($shipment->user->email); ?></td>
          
          <td class="tdl" colspan="2" rowspan="6" valign="top" align="center"><div id="qrcode" valign="top"><?php echo DNS2D::getBarcodeHTML($home_add.'tracking/'.$shipment->consignment_no, 'QRCODE',2,2, '#ec6400'); ?></div><br><span style="font-size:8px;">Track & Comments</span></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td colspan="2" class="tdl1">&nbsp;<?php echo e($shipment->customer_name); ?></td>
          <td class="tdl">&nbsp;Date</td>
          <td class="tdl">&nbsp;<?php echo e($shipment->created_at->format('d/m/Y')); ?></td>
          <td class="tdl">&nbsp;Time</td>
          <td class="tdl">&nbsp;<?php echo e($shipment->created_at->format('H:m')); ?></td>
        </tr>
        <tr>
          <td colspan="3" class="tdl" valign="top" width=290><?php echo e($shipment->customer_address); ?><BR><?php echo e($shipment->customer_phone); ?><BR><?php echo e($shipment->customer_email); ?></td>
          <td class="tdl" rowspan="1">Origin City</td>
          <td class="tdl" rowspan="1"></td>
          <td class="tdl" rowspan="1">Destination</td>
          <td class="tdl" rowspan="1"><?php echo e($shipment->destination_city); ?></td>
        </tr>
        <tr>
          <td class="tdl">&nbsp;Pieces &nbsp;&nbsp;&nbsp;<span class="tdl1">&nbsp;&nbsp;<?php echo e($shipment->quantity); ?></span></td>
          <td class="tdl">&nbsp;Weight &nbsp;&nbsp;<span class="tdl1">&nbsp;&nbsp;<?php echo e($shipment->weights->weight); ?></span></td><td class="tdl">&nbsp;Cash Collect </td><td class="tdl">&nbsp; Rs.<?php echo e($shipment->product_value); ?>/-</td>
          <td class="tdl">&nbsp;Service</td>
          <td class="tdl" colspan="2">&nbsp;<?php echo e($shipment->service_type); ?></td>
        </tr>
        
        <tr>
          <td class="tdl">&nbsp;Remarks: </td>
          <td class="tdl" colspan="3"><?php echo e($shipment->remarks); ?> </td>
          <td class="tdl"> Ref:</td>
          <td class="tdl" colspan="3" style="font-size:12px;"><?php echo e($shipment->product_reference); ?></td>
        </tr>
    ...
    <td>
      <table class="tab" cellpadding="0" cellspacing="0" style="font-size:10px;font-family:arial;">
        ...
        <td rowspan="3" class="tdl" width="100">&nbsp;<img src="<?php echo e(asset('assets/images/zippy/logo.svg')); ?>" height=33 width=90><br><span style="font-size:10px; ">&nbsp;&nbsp;A ZIPPY (Pvt) Ltd<?php echo e($shipment->consignment_no); ?></span>
          ...
          <td rowspan="3" colspan="2" valign="bottom" width="85" class="tdl" align="center"><div id="barcodec" style="font-weight: 100;">
            <?php echo DNS1D::getBarcodeHTML($shipment->consignment_no, 'C39E', 1,33,'black', true);; ?></div><span style="font-size:9px;">Customer Copy</span></td>
          <td class="tdl" rowspan="3" colspan="4"><span style="font-weight: bold; font-size: 14px;"><?php echo e($shipment->user->company->company_name); ?></span> <br><?php echo e($shipment->user->company->address); ?><br><?php echo e($shipment->user->company->phone); ?><br><?php echo e($shipment->user->email); ?></td>
        ...
        <tr>
          <td class="tdl">&nbsp;Note</td><td class="tdl" colspan="7">Please only pay Rs.<?php echo e($shipment->product_value); ?>/- to the courier when you recieve your shipment. No additional fees or deposit should be paid.</td>
        </tr>
      </table>
    </td>
  </tr>
    ...
    <td>
      <table class="tab" cellpadding="0" cellspacing="0" style="font-size:10px;font-family:arial;">
        ...
        <td rowspan="3" class="tdl" width="100">&nbsp;<img src="<?php echo e(asset('assets/images/zippy/logo.svg')); ?>" height=33 width=90><br><span style="font-size:10px; ">&nbsp;&nbsp;A ZIPPY (Pvt) Ltd<?php echo e($shipment->consignment_no); ?></span>
          ...
          <td rowspan="3" colspan="2" valign="bottom" width="85" class="tdl" align="center"><div id="barcodec" style="font-weight: 100;">
            <?php echo DNS1D::getBarcodeHTML($shipment->consignment_no, 'C39E', 1,33,'black', true);; ?></div><span style="font-size:9px;">Vendor Copy</span></td>
          <td class="tdl" rowspan="3" colspan="4"><span style="font-weight: bold; font-size: 14px;"><?php echo e($shipment->user->company->company_name); ?></span> <br><?php echo e($shipment->user->company->address); ?><br><?php echo e($shipment->user->company->phone); ?><br><?php echo e($shipment->user->email); ?></td>
...
</html><?php /**PATH D:\Zippy\resources\views/shipments/cn.blade.php ENDPATH**/ ?>