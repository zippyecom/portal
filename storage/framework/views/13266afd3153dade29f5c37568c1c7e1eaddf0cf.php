                   ...
                   <tbody>
                    <?php $__currentLoopData = $shipments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shipment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                        ...
                        <td><span class="badge badge-danger"><?php echo e($shipment->status); ?></span></td>
                        <td>
                          <a href="/shipment/cn/<?php echo e($shipment->id); ?>"><button class="btn btn-primary btn-xs"><i class="fa fa-print btn-action"></i></button></a>
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <?php if($shipment->status == "Booked"): ?>
                                    <a class="btn btn-success btn-block" href="/shipment-cancel/<?php echo e($shipment->id); ?>">Cancel Shipment</a>
                                  <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Zippy\Zippy\resources\views/shipments/customer-shipments.blade.php ENDPATH**/ ?>