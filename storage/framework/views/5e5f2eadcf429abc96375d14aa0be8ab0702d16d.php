...
<body>
  ...
  <?php $__currentLoopData = $keyvalue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  ...
  <table style=" background-color: #F8FEFF;">
    ...
    <img src="KCSLogo.png" alt="" style="margin-top: 0px;">
      ...
      <td colspan="2" style="width:350px;">
        ...
        <p style="margin-top:0px"><center> <?php echo e($key->number); ?> </center></p>
...
</html><?php /**PATH D:\Zippy\resources\views/admin/account/export_pdf.blade.php ENDPATH**/ ?>