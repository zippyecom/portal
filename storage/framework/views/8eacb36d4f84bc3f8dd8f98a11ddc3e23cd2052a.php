      ...
      <div class="main-navbar">
         ...
         <div id="mainnav">
            ...
            <ul class="nav-menu custom-scrollbar">
               ...
               <li class="dropdown">
                  <a class="nav-link menu-title <?php echo e(Route::currentRouteName() == 'collection' ? 'active' : ''); ?>" href="<?php echo e(route('collection')); ?>"><i data-feather="file-text"></i><span>Collection</span>
                  </a>
               </li>
               <li class="dropdown">
               ...
               <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add_user')): ?>
                  ...
                  <li class="dropdown">
                     <a class="nav-link menu-title <?php echo e(request()->route()->getPrefix() == '/account' ? 'active' : ''); ?>" href="#"><i data-feather="activity"></i><span>Account</span>
                        <div class="according-menu"><i class="fa fa-angle-double-<?php echo e(request()->route()->getPrefix() == '/account' ? 'down' : 'right'); ?>"></i></div>
                     </a>
                     <ul class="nav-submenu menu-content" style="display: <?php echo e(request()->route()->getPrefix() == '/account' ? 'block;' : 'none'); ?>">
                        <li><a href="<?php echo e(route('account.create')); ?>" class="<?php echo e(Route::currentRouteName()=='account.create' ? 'active' : ''); ?>">Create account</a></li>
                        <li><a href="<?php echo e(route('account.index')); ?>" class="<?php echo e(Route::currentRouteName()=='account.index' ? 'active' : ''); ?>">Show account</a></li>
                     </ul>
                  </li>
               ...
               <?php if(auth()->check() && auth()->user()->hasRole('admin|operation|rider|account')): ?>
               <li class="dropdown">
...
</header><?php /**PATH D:\Zippy\resources\views/layouts/simple/sidebar.blade.php ENDPATH**/ ?>