...
<?php $__env->startSection('title', 'Advices not done shipments'); ?>
                   ...
                   <tbody>
                    <?php $__currentLoopData = $shipments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shipment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                        ...
                        <td><?php echo e($shipment->return_advice); ?></td>
                        <td>
                          <a data-toggle="modal" href="#viewModal<?php echo e($shipment->id); ?>" title="View"><button class="btn btn-primary btn-xs"><i class="fa fa-eye btn-action"></i></button></a>
                          ...
                          <a href="<?php echo e(route('shipment.advice', $shipment->id)); ?>" title="Submit advice"><button class="btn btn-success btn-xs"><i class="fa fa-check btn-action"></i></button></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Zippy\Zippy\resources\views/shipments/customer-advices/not-done.blade.php ENDPATH**/ ?>