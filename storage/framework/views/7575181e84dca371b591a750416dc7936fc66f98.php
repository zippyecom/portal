               ...
               <div class="">
                  <div class="project-overview" style="margin-top: 8%;">
                     <div class="row">
                        ...
                        <div class="col-xl-2 col-sm-4 col-6">
                           <h2 class="f-w-600 counter font-success"><?php echo e($total_accounts); ?></h2>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Zippy\resources\views/dashboard/index.blade.php ENDPATH**/ ?>