               ...
               <li class="dropdown">
                  ...
                  <ul class="nav-submenu menu-content" style="display: {{request()->route()->getPrefix() == '/starter-kit' ? 'block;' : 'none' }}">
                     ...
                     <li>
                        ...
                        <ul class="nav-sub-childmenu submenu-content" style="display: {{ in_array(Route::currentRouteName(), ['layout-box', 'layout-rtl', 'compact-layout', 'vertical-layout', 'dark-rtl-layout', 'vertical-rtl-layout', 'compact-rtl-layout', 'dark-box-layout', 'vertical-box-layout', 'compact-dark-layout']) ? 'none' : 'none' }};">
