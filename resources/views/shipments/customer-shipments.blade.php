                   ...
                   <tbody>
                    @foreach ($shipments as $shipment)
                      <tr>
                        ...
                        <td><span class="badge badge-danger">{{ $shipment->status}}</span></td>
                        <td>
                          <a href="/shipment/cn/{{$shipment->id}}"><button class="btn btn-primary btn-xs"><i class="fa fa-print btn-action"></i></button></a>
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  @if($shipment->status == "Booked")
                                    <a class="btn btn-success btn-block" href="/shipment-cancel/{{$shipment->id}}">Cancel Shipment</a>
                                  @endif
