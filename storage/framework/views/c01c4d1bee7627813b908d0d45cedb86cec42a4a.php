...
<div class="container-fluid">
  <div class="row">
     <div class="col-sm-12" style="padding-right: 0px; padding-left: 0px;">
      <form action="<?php echo e(route('booking.store')); ?>" method="POST"  id="myForm" enctype="multipart/form-data">
        <div class="card">
                        ...
                        <div class="form-group row w-100">
                            ...
                            <div class="col-md-2">
                              ...
                              <select class="form-control mt-2" id="goods_type" name="goods_type">
                                ...
                                <option value="<?php echo e($good->name); ?>"><?php echo e($good->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </select>
                            </div>
                             <div class="col-md-2">
                              ...
                              <select class="form-control mt-2"  name="packing_type">
                                ...
                                <option value="<?php echo e($packing->name); ?>"><?php echo e($packing->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </select>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Zippy\resources\views/admin/customer/bookingform.blade.php ENDPATH**/ ?>